...
class Collator(object):
    def __init__(self, text_max_length, tokenizer, fix_max_length=128):
...
class RetrieverCollator(object):
    def __init__(self, tokenizer, context_max_length=258, bug_max_length=62):
        self.tokenizer = tokenizer
...
class TextCollator(object):
    def __init__(self, tokenizer, max_length=258):
        self.tokenizer = tokenizer
