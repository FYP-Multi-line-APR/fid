...
class Options():
    ...
    def add_reader_options(self):
        ...
        self.parser.add_argument('--text_max_length', type=int, default=320, 
                        help='maximum number of tokens in text segments (question+passage)')
        self.parser.add_argument('--fix_max_length', type=int, default=128, 
    ...
    def add_retriever_options(self):
        ...
        self.parser.add_argument('--bug_max_length', type=int, default=62, 
                        help='maximum number of tokens in bugs')
        self.parser.add_argument('--context_max_length', type=int, default=320, 
                        help='maximum number of tokens in context')
        self.parser.add_argument('--no_bug_mask', action='store_true')
        self.parser.add_argument('--no_context_mask', action='store_true')
